...
## 頻出ひっかけ
- **要配慮個人情報に「国籍・肌の色・出生地・戸籍」は含まれない**（人種とは別扱い）。
- **匿名加工＝本人同意なく第三者提供可／仮名加工＝原則不可**（本人同意があっても不可）。
- **AI事業者ガイドライン＝経産省・総務省**、**人間中心のAI社会原則＝内閣府**。所管を混同しない。
- **著作権法30条の4＝非享受利用（情報解析）**は許諾不要。ただし利益を不当に害する場合は除外。
- **EU AI Act＝リスクベース4段階**（許容不可＝禁止／高／限定／最小）。
- ガイドライン類は**ソフトロー**（法的拘束力なし）、EU AI Actは**ハードロー**。
